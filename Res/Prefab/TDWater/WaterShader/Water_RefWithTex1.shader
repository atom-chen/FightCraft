	...
	Pass {
		...
		v2f_full vert (appdata_full v) 
		{
			...
			o.viewInterpolator.xyz -= _WorldSpaceCameraPos;	
			 ...
			 //COMPUTE_EYEDEPTH(o.viewInterpolator.w);
		...
		{	
			...
			//half3 viewSpaceWaterDepth = mul(UNITY_MATRIX_V,i.viewInterpolator);µ			
			//waterDepth = Linear01Depth(waterDepth);
			
			half4 edgeBlendFactors = half4(1.0, 0.0, 0.0, 0.0);			
			
			//modify 3-12
			//half viewSpaceDepth = UNITY_SAMPLE_DEPTH(tex2Dproj(_CameraDepthTexture , UNITY_PROJ_COORD(i.screen)));
