...
namespace GameBase
{
    ...
    public enum EVENT_TYPE
    {
        ...
        EVENT_UI_SHOW_MENBER,
        EVENT_UI_SHOW_MENBERINFO,
        EVENT_UI_SHOW_CAPTURE,
        EVENT_UI_SHOW_CAPTURE_LIST,
        EVENT_UI_SHOW_CAPTURE_INFO,
        EVENT_UI_SHOW_CAPTURE_RESULT,
        EVENT_UI_SHOW_SCENE_CAPTHER,
        EVENT_UI_SHOW_SCENE_LEVEL,
        EVENT_UI_SHOW_CAPTURE_RESULT_FINISH,
