...
public class ConEquipPutOn : MissionConditionBase
{
    ...
    public override void InitCondition(MissionItem missionData, Tables.MissionRecord missionRecord)
    {
        ...
        _EquipPos = int.Parse(missionRecord.ConditionParams[2]);
    ...
    private void EventDelegate(object go, Hashtable eventArgs)
    {
        ...
        if (_EquipPos != -1 && (int)equipInfo.EquipItemRecord.Slot != _EquipQuality)
            return;
