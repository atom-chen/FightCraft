...
namespace GameUI
{
    public class UISkillLevelUp : UIBase
    {
        ...
        {
            _SkillClass.InitSelectContent(SkillPack.Instance.SkillClassItems.Keys, new List<Tables.SKILL_CLASS>() { Tables.SKILL_CLASS.NORMAL_ATTACK }, SelectSkillClass);
        }
        ...
        {
            _SkillInfos.InitSelectContent(SkillPack.Instance.SkillClassItems[skillClass], null, SelectSkillItem);
        }
        ...
        public void OnBtnSkillLvUp()
        {
            ...
            SkillPack.Instance.SkillLevelUp(_SelectedSkill._SkillID);
            RefreshSkillInfos();
        }
