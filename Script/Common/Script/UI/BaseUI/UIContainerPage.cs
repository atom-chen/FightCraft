...
namespace GameUI
{
    public class UIContainerPage : UIContainerBase
    {
        ...
        public override void InitContentItem(IEnumerator enumerator, Hashtable exhash = null, UIItemBase.ItemClick onClick = null)
        {
            base.InitContentItem(enumerator, exhash, onClick);
