...
namespace GameUI
{
    public class UIManager : MonoBehaviour
    {
        ...
        public const string UI_SYSTEM_SCRIPT_PATH = "\\FightCraft\\Common\\Script\\UI\\SystemUI";
        public const string UI_LOGIC_SCRIPT_PATH = "\\FightCraft\\Common\\Script\\UI\\LogicUI";
        ...
        private static string GetUIObjPath(string path)
        {
            ...
            string uiPath = "";
            for (int i = 5; i < pathStrs.Length - 1; ++i)
            {
                uiPath += pathStrs[i] + '/';
            }
